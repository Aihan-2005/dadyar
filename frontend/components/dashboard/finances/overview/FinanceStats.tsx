    ...
    StatCardConfig[] = [
      {
        ...
        description:
          'مجموع مبلغ قراردادهای موجود در گزارش فعلی',
...

      {
        ...
        badge:
          `${stats.collectionRate.toLocaleString(
            'fa-IR',
            {
...

      {
        ...
        description:
          'هزینه‌های مرتبط با پرونده‌های گزارش',
...

      {
        ...
        description:
          'دریافتی پس از کسر هزینه‌های ثبت‌شده',
...

      {
        ...
        description:
          'نسبت دریافتی به ارزش قراردادها',
...

      {
        ...
        description:
          `${stats.clientCount.toLocaleString(
            'fa-IR'
          )} موکل در گزارش فعلی`,
