...
const FAQ_ITEMS = [
  ...
  {
    id: 'fix-bug',
    question: 'اگر با یک خطا یا باگ مواجه شدم چه کار کنم؟',
    answer:
      'می‌توانید از طریق فرم زیر همین صفحه، موضوع را با انتخاب گزینه «باگ» برای ما ارسال کنید تا در سریع‌ترین زمان بررسی کنیم.',
  },
  {
    id: 'add-case',
    question: 'چطور یک پرونده جدید ثبت کنم؟',
    answer:
      'از منوی کناری، روی دکمه «پرونده جدید» کلیک کنید و اطلاعات پرونده را در فرم مربوطه وارد کنید.',
  },
  {
    id: 'suggestion',
    question: 'چطور می‌توانم پیشنهادی برای بهتر شدن سایت ارسال کنم؟',
    answer:
      'از فرم زیر همین صفحه، گزینه «پیشنهاد» را انتخاب کرده و ایده‌ی خود را برای ما بنویسید.',
  },
]
