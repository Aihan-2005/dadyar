    ...
    <div className="min-h-screen bg-zinc-50">
      <div className="mx-auto max-w-7xl space-y-8 p-4 sm:p-6 md:p-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-zinc-500">
                گزارش یکپارچه قراردادها، وصول، معوقات، هزینه‌ها و تحلیل جریان نقدی
              </p>
            </div>
          </div>
        ...
        <div className="flex min-h-5 flex-wrap items-center justify-between gap-2 text-xs text-zinc-400">
          <p>
            آمار و تحلیل پایین بر مبنای فیلترهای فعال محاسبه می‌شوند.
          </p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-xs text-zinc-500">
                          نتایج این جدول فقط از پرونده‌های موجود در فیلتر فعلی ساخته شده است.
                        </p>
                      </div>
                    </div>
