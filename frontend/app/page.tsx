        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[1.08fr_0.92fr] lg:px-8 lg:py-24">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-slate-700 sm:text-lg sm:leading-9">
              دادیار برای وکلا ابزار مدیریت پرونده،
              موکل، مالی و قرارداد فراهم می‌کند و
              برای موکلین مسیر انتخاب وکیل، ارتباط،
              رزرو مشاوره، قرارداد آنلاین، پیگیری
              درخواست و تنظیم لایحه را کنار هم قرار
              می‌دهد.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base font-medium leading-8 text-slate-700">
              ...
              فرآیندهای روزانه دفتر را از یک محیط
              منظم مدیریت کنید.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-base font-medium leading-8 text-slate-700">
                بدون ورود می‌توانید وکلا و خدمات را
                مشاهده کنید. هنگام ثبت درخواست،
                رزرو، قرارداد یا ذخیره اطلاعات شخصی،
                حساب موکل وارد جریان می‌شود.
              </p>
            </div>

            <Link
              href="/client-portal"
              className="inline-flex h-12 shrink-0 items-center justify-center gap-2 rounded-xl bg-emerald-600 px-5 text-sm font-black text-white transition hover:bg-emerald-700"
            >
              ورود به بخش موکلین
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-2">
            <article className="rounded-[26px] border border-blue-200 bg-blue-50 p-6 sm:p-7">
              ...
              <ol className="mt-5 space-y-4">
                ...
                <WorkflowStep
                  number="۲"
                  text="صفحه تایید خرید را بررسی کنید و سپس وارد حساب وکیل شوید یا ثبت‌نام کنید."
                />
            ...
            <article className="rounded-[26px] border border-emerald-200 bg-emerald-50 p-6 sm:p-7">
              ...
              <Link
                href="/client-portal"
                className="mt-6 inline-flex h-11 items-center gap-2 rounded-xl bg-emerald-600 px-5 text-sm font-black text-white transition hover:bg-emerald-700"
              >
                خدمات موکلین
