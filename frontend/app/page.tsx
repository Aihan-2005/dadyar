...
export default function PricingPage() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        {/* Header */}
        ...
        <section className="mx-auto mb-1 mt-7 max-w-3xl text-center sm:mt-14">
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              {plan.href ? (
                <Link
                  href={plan.href}
                  className="flex h-13 w-full items-center justify-center rounded-2xl bg-gradient-to-l from-blue-600 to-blue-700 text-sm font-black text-white shadow-md shadow-blue-200 transition hover:from-blue-700 hover:to-blue-800"
                >
                  {plan.action}
                </Link>
              ) : (
                <button
                  type="button"
                  disabled
                  className="flex h-13 w-full cursor-not-allowed items-center justify-center rounded-2xl border border-slate-300 bg-slate-200 text-sm font-bold text-slate-500"
                >
                  {plan.action}
                </button>
              )}
